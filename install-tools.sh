...
# Create CCS_DIR if it doesn't exist
mkdir -p "$CCS_DIR"
...
install_kustomize() {
  ...
  if ! command -v kustomize &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/kustomize.tar.gz https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize%2Fv5.6.0/kustomize_v5.6.0_linux_amd64.tar.gz"
    run_cmd "tar -zxvf $CCS_DIR/kustomize.tar.gz -C $CCS_DIR"
    run_cmd "mv $CCS_DIR/kustomize /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/kustomize"
    run_cmd "rm $CCS_DIR/kustomize.tar.gz"
  fi
...
install_k9s() {
  ...
  if ! command -v k9s &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/k9s.tar.gz https://github.com/derailed/k9s/releases/download/v0.40.5/k9s_Linux_amd64.tar.gz"
    run_cmd "tar -zxvf $CCS_DIR/k9s.tar.gz -C $CCS_DIR"
    run_cmd "mv $CCS_DIR/k9s /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/k9s"
    run_cmd "rm $CCS_DIR/k9s.tar.gz $CCS_DIR/LICENSE $CCS_DIR/README.md"
  fi
...
install_mkcert() {
  ...
  if ! command -v mkcert &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/mkcert https://github.com/FiloSottile/mkcert/releases/download/v1.4.4/mkcert-v1.4.4-linux-amd64"
    run_cmd "chmod +x $CCS_DIR/mkcert"
    run_cmd "mv $CCS_DIR/mkcert /usr/local/bin/"
...
install_kube_hunter() {
  ...
  if ! command -v kube-hunter &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/kube-hunter https://github.com/aquasecurity/kube-hunter/releases/download/v0.6.8/kube-hunter-linux-x86_64-refs.tags.v0.6.8"
    run_cmd "mv $CCS_DIR/kube-hunter /usr/local/bin/"
...
install_kube_linter() {
  ...
  if ! command -v kube-linter &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/kube-linter.tar.gz https://github.com/stackrox/kube-linter/releases/download/v0.7.2/kube-linter-linux.tar.gz"
    run_cmd "tar -zxvf $CCS_DIR/kube-linter.tar.gz -C $CCS_DIR"
    run_cmd "mv $CCS_DIR/kube-linter /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/kube-linter"
    run_cmd "rm $CCS_DIR/kube-linter.tar.gz $CCS_DIR/LICENSE $CCS_DIR/README.md"
  fi
...
install_terrascan() {
  ...
  if ! command -v terrascan &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/terrascan.tar.gz https://github.com/tenable/terrascan/releases/download/v1.19.9/terrascan_1.19.9_Linux_x86_64.tar.gz"
    run_cmd "tar -zxvf $CCS_DIR/terrascan.tar.gz -C $CCS_DIR"
    run_cmd "mv $CCS_DIR/terrascan /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/terrascan"
    run_cmd "rm $CCS_DIR/terrascan.tar.gz $CCS_DIR/CHANGELOG.md $CCS_DIR/LICENSE $CCS_DIR/README.md"
  fi
...
install_kubeaudit() {
  ...
  if ! command -v kubeaudit &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/kubeaudit.tar.gz https://github.com/Shopify/kubeaudit/releases/download/v0.22.2/kubeaudit_0.22.2_linux_amd64.tar.gz"
    run_cmd "tar -zxvf $CCS_DIR/kubeaudit.tar.gz -C $CCS_DIR"
    run_cmd "mv $CCS_DIR/kubeaudit /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/kubeaudit"
    run_cmd "rm $CCS_DIR/kubeaudit.tar.gz $CCS_DIR/README.md"
  fi
...
install_nuclei() {
  ...
  if ! command -v nuclei &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/nuclei_3.3.9_linux_amd64.zip https://github.com/projectdiscovery/nuclei/releases/download/v3.3.9/nuclei_3.3.9_linux_amd64.zip"
    run_cmd "unzip $CCS_DIR/nuclei_3.3.9_linux_amd64.zip -d $CCS_DIR"
    run_cmd "mv $CCS_DIR/nuclei /usr/local/bin/"
    run_cmd "chmod +x /usr/local/bin/nuclei"
    run_cmd "rm $CCS_DIR/nuclei_3.3.9_linux_amd64.zip $CCS_DIR/README_CN.md $CCS_DIR/README_ID.md $CCS_DIR/README_KR.md $CCS_DIR/LICENSE.md $CCS_DIR/README_ES.md $CCS_DIR/README_JP.md $CCS_DIR/README.md"
  fi
...
install_kube_review() {
  ...
  if ! command -v kube-review &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/kube-review.zip https://github.com/anderseknert/kube-review/releases/download/v0.4.0/kube-review-linux-amd64.zip"
    run_cmd "unzip $CCS_DIR/kube-review.zip -d $CCS_DIR"
    run_cmd "mv $CCS_DIR/kube-review-linux-amd64 /usr/local/bin/kube-review"
    run_cmd "chmod +x /usr/local/bin/kube-review"
    run_cmd "rm $CCS_DIR/kube-review.zip"
  fi
...
install_chisel() {
  ...
  if ! command -v chisel &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/chisel_1.10.1_linux_amd64.gz https://github.com/jpillora/chisel/releases/download/v1.10.1/chisel_1.10.1_linux_amd64.gz"
    run_cmd "gzip -d $CCS_DIR/chisel_1.10.1_linux_amd64.gz"
    run_cmd "mv $CCS_DIR/chisel_1.10.1_linux_amd64 /usr/local/bin/chisel"
...
install_static_curl() {
  ...
  if ! command -v static-curl &> /dev/null; then
    run_cmd "curl -Lo $CCS_DIR/curl-amd64 https://github.com/moparisthebest/static-curl/releases/download/v8.11.0/curl-amd64"
    run_cmd "chmod +x $CCS_DIR/curl-amd64"
    run_cmd "mv $CCS_DIR/curl-amd64 /usr/local/bin/static-curl"
  fi
